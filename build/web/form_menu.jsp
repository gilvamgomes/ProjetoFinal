...
<body>
   ...
   <div class="content">
    <h2 class="titulo-usuario">Cadastrar Menu</h2>
    <form action="GerenciarMenu" method="POST" class="painel-usuario">
        ...
        <a href="listar_menu.jsp" class="btn btn-usuario">Voltar</a>
    </form>
</div>
