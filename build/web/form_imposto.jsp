...
<body>
    ...
    <div class="content">
    <h2 class="titulo-usuario">Cadastrar Imposto</h2>
    <form action="GerenciarImposto" method="POST" class="painel-usuario">
        ...
        <a href="listar_imposto.jsp" class="btn btn-usuario">Voltar</a>
    </form>
</div>
